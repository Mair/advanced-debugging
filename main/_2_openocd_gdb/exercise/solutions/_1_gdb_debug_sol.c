...
static void append_linked_list(int fib_number)
{
     ...
     *      current->fib_number is being overwritten
     * 10. why is this happing
     *  null terminator of string overriding number when copying string
